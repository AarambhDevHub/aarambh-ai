...
pub fn flash_attention_forward(
    ...
    #[cfg(not(all(feature = "cuda", aarambh_cuda_kernels)))]
    {
        ...
        Err(candle_core::Error::msg(
            "Flash Attention CUDA is unavailable because aarambh-studio-kernel was built without CUDA PTX kernels",
        ))
    }
}
...
mod cuda {
    ...
    const FWD_PTX: &str = include_str!(env!("AARAMBH_STUDIO_CUDA_FLASH_ATTN_PTX"));
