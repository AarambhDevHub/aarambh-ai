...
use aarambh_ai_core::{AarambhError, Configurable, ModelConfig, Result, TokenizerLike};
...
impl LocalCheckpointTeacher {
    ...
    pub fn from_paths(
        ...
        let model =
            aarambh_ai_weights::load_any_model_with_dtype(model_path, config, &device, dtype)?;
