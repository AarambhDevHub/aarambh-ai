...
use aarambh_ai_nn::HybridKvCache;
...
impl KvCache {
    ...
    pub fn new(n_layers: usize) -> Self {
        Self {
            layers: (0..n_layers)
                .map(|_| HybridKvCache::Full(aarambh_ai_nn::KVCache::new()))
                .collect(),
        }
    }
...
mod tests {
    ...
    use aarambh_ai_core::{GatedDeltaNetConfig, HybridAttentionSchedule, ModelConfig};
    use aarambh_ai_model::AarambhModel;
